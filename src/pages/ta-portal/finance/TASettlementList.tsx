...
export const TASettlementList: React.FC<{ navigate: (path: string, state?: any) => void }> = ({ navigate }) => {
    ...
    { 
      accessor: (row: any) => (
        <DropdownMenu
          ...
          iconOnly
          items={[
            { id: 'view_details', label: 'View Details', icon: <Eye size={16} />, onClick: () => navigate('ta-finance-settlement-details', { id: row.id }) },
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
      <PageHeader 
        ...
        subtitle="Monitor settlement preparations and reconciliation records."
        actions={
