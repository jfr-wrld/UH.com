...
import { Plus, Download, FileText, Share2, MoreVertical, Eye } from 'lucide-react';
import { DropdownMenu } from '../../../components/actions/DropdownMenu';

export const AdminInvoiceList: React.FC<{ navigate: (path: string, state?: any) => void }> = ({ navigate }) => {
    ...
    { 
      accessor: (row: any) => (
        <DropdownMenu
          ...
          iconOnly
          items={[
            { id: 'view_details', label: 'View Details', icon: <Eye size={16} />, onClick: () => navigate('admin-finance-invoice-details', { id: row.id }) },
      ...
      <PageHeader 
        ...
        actions={
          <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
            ...
            <Button leftIcon={<Plus size={16} />} onClick={() => navigate('admin-finance-invoice-create')}>
