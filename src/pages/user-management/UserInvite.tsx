      ...
      <PageHeader 
        ...
        actions={
          <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
            <Button variant="ghost" onClick={() => { if(showToast) showToast('Success', 'Action completed successfully', 'success'); navigate('um-users'); }}>Cancel</Button>
            <Button onClick={() => navigate('um-users')}>Send Invitation</Button>
          </div>
        }
      />
