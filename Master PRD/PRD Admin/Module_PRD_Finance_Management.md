...
└── PRD 11.7 Referral Reward Handoff
```
...
| Referral Reward Handoff | Receive approved referral rewards from the Referral module to be paid out by Finance |
...
| Referral Reward Management | Hands off approved referral rewards to Finance for final payout processing |
...
flowchart TD
    ...
    COMM --> PO
    REF_MGT["Referral Reward Management"] -->|Approved Handoff| PO
    SEA["Season"] --> PKG
...
2. Agent commission.
3. Public referral commission / Approved Referral Rewards via Finance Handoff.
...
13. Finance can receive and process approved referral rewards from the Referral Reward Finance Handoff queue.
14. All finance status changes create activity logs.
15. Unauthorized users cannot view sensitive finance details.
16. The module is usable on desktop, tablet, and mobile web.
